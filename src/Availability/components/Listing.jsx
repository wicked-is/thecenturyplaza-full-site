...
const Listing = (props) => {
  ...
  return (
    <tr>
      ...
      <td>{listing.acf.beds} / {listing.acf.baths}</td>
      <td>{listing.acf.interior_square_ft} / {getSqMetersFromSqFeet(listing.acf.interior_square_ft)}</td>
      ...
      <td><a href={listing.acf.floor_plan} target="_blank" rel="noopener noreferrer">DOWNLOAD</a></td>
    </tr>
  );
};
